...
## Phase 6: Coin 지갑 / 유료 필터 / Pro / 정산 (6주)

### Tasks

| ID | Task | 의존 | MD | 위험 |
|---|---|---|---|---|
| 6-01 | Coin economy config (`/config/economy`) + product catalog | - | 2 | 중 |
| 6-02 | StoreKit 2 Coin 충전 클라이언트 (100/550/1200/3000 C) | 6-01 | 4 | 높음 |
| 6-03 | `/wallet/topup/init` + `/wallet/topup/finalize` 영수증 검증 | 6-02 | 4 | 높음 |
| 6-04 | Wallet 메인 + 거래 ledger (`43`, `45`) | 6-03 | 3 | 중 |
| 6-05 | Coin 기반 필터 구매 + 잔액 부족 모달 (`37`, `46`) | 6-04 | 4 | 높음 |
| 6-06 | 보유 필터/구매 이력/환불 상태 (`39`) | 6-05 | 3 | 중 |
| 6-07 | Pro 멤버십 구독 (`38`) — 무제한 + 월 300 C 보너스 | 6-03 | 4 | 높음 |
| 6-08 | 메이커 KYC + Stripe Connect Express 가입 플로우 (`40`) | 6-04 | 5 | 높음 |
| 6-09 | 세무 정보 / payout profile (`41`) | 6-08 | 2 | 중 |
| 6-10 | 메이커 출금 신청/내역/대시보드 (`47`, `42`, `28`) | 6-09 | 5 | 중 |
| 6-11 | 환불 정책, Apple transaction updates, Coin 환원/회수 | 6-06 | 3 | 높음 |
| 6-12 | 유료 컨텐츠 인앱 프로모션 | 6-05 | 2 | 낮음 |

**Phase 6 총합**: ~41MD ≈ 6주 × 3명

### 종료 조건
- [ ] 첫 매출 발생
- [ ] Coin 충전/사용/환불 ledger 정합성 100%
- [ ] 메이커 정산 100% 정확
- [ ] 결제 성공률 ≥ 95%
