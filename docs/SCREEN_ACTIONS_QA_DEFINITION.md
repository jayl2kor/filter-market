...
| `camera.capturePreview` | after shutter | `CapturePreviewScreen` | Partial, Blocked on camera | `preview.dismiss`, `preview.more`, `preview.more.info`, `preview.more.changeFilter`, `preview.more.copyMetadata`, `preview.retake`, `preview.changeFilter`, `preview.edit`, `preview.discard`, `preview.save`, `preview.share` |
