...
| `reviews.compose` | `AppRoute.reviewCompose(filterId:)` | `ReviewComposeScreen` | Implemented, NeedsE2E | `social.compose.rating.star.*`, `social.compose.rating.label`, `social.compose.input`, `social.compose.send`, `social.compose.error`, `social.review.makerReply`, `social.compose.insertMention`, `social.compose.attachImage`, `social.compose.removeImage`, `social.compose.emojiToggle`, `social.compose.emoji.*` |
